...
if ARGV.length < 3
	puts "#{cor.branco}--------------------------------------------------------------------------"
	puts "#{cor.verde}USAR: crunch <min> <max> [options] | ruby bftp.rb [HOST] [PORTA] [USUÁRIO]"
	puts "#{cor.branco}--------------------------------------------------------------------------"
	puts "#{cor.verde}Ex: crunch 4 8 possiveiscaracteres | ruby bftp.rb servidorFTP 21 Anonymous"
	puts "#{cor.branco}--------------------------------------------------------------------------"
	exit()	
end
